...
def net_factory(net_type, in_chns, class_num):
    ...
    if net_type == "unet":
        ...
        net = ViM_seg(config, img_size=args.patch_size, num_classes=class_num, in_cha=in_chns).cuda()
    elif net_type == "hyb_VIM_att":
        net = hyb_VIM_att(config, img_size=args.patch_size, num_classes=class_num, in_cha=in_chns).cuda()
    else:
        net = None
    return net
