    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            logging.info(
                ...
                (iter_num, loss.item(), loss_ce.item(), 1-loss_dice.item()))

            if iter_num % 20 == 0:
                image = volume_batch[1, 0:1, :, :]
                writer.add_image('train/Image', image, iter_num)
                pred = torch.argmax(outputs_soft, dim=1, keepdim=True)
...
if __name__ == "__main__":
    ...
    snapshot_path = "/home/tzou/MyoSAIQ/Mamba_model/{}_{}_labeled/{}".format(
